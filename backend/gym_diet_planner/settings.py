"""
Django settings for gym_diet_planner project.
Production-ready configuration with JWT, CORS, and PostgreSQL support.
"""
...
ROOT_URLCONF = 'gym_diet_planner.urls'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'gym_diet_planner'),
